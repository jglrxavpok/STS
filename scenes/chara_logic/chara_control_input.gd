...
var _physical_action_name: String
var _special_attack_action_name: String
...
func _init(_player_index: int):
	...
	_physical_action_name = Inputs.get_player_input_name(player_index, "physical_attack")
	_special_attack_action_name = Inputs.get_player_input_name(player_index, "special_attack")
...
func update_chara_controls():
	...
	self.pressed_physical_attack = Input.is_action_pressed(_physical_action_name);
	self.pressed_special_attack = Input.is_action_pressed(_special_attack_action_name);
