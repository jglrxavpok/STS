...
func _init(player_index: int):
	super._init(player_index)
...
func update_chara_controls(chara: STS_Character):
	var dir = 0.0
	...
	chara.in_direction = dir
	chara.in_jump = Input.is_action_pressed(_jump_action_name)
